          ...
          <div class="recent-post-wrap">
              ...
              <div class="media-body">
                <h4 class="post-title">
                  <a class="hover-line" href="blog-details.html"
                    >Fitness: Your journey to Better, stronger you.</a
                  >
                </h4>
                <div class="recent-post-meta">
                  <a href="blog.html"
                    ><i class="fal fa-calendar-days"></i>21 June, 2023</a
                  >
                </div>
              </div>
            </div>
            <div class="recent-post">
              ...
              <div class="media-body">
                <h4 class="post-title">
                  <a class="hover-line" href="blog-details.html"
                    >Embrace the game Ignite your sporting</a
                  >
                </h4>
                <div class="recent-post-meta">
                  <a href="blog.html"
            ...
            <div class="recent-post">
              ...
              <div class="media-body">
                <h4 class="post-title">
                  <a class="hover-line" href="blog-details.html"
                    >Revolutionizing lives Through technology</a
                  >
                </h4>
                <div class="recent-post-meta">
                  <a href="blog.html"
                    ><i class="fal fa-calendar-days"></i>23 June, 2023</a
                  >
                </div>
              </div>
            </div>
            <div class="recent-post">
              ...
              <div class="media-body">
                <h4 class="post-title">
                  <a class="hover-line" href="blog-details.html"
                    >Enjoy the Virtual Reality embrace the</a
                  >
                </h4>
                <div class="recent-post-meta">
                  <a href="blog.html"
                    ><i class="fal fa-calendar-days"></i>25 June, 2023</a
                  >
                </div>
              </div>
            </div>
        ...
        <div class="widget newsletter-widget">
          ...
          <div class="mt-30">
            ...
            <label for="Agree2"
              ...
              <a href="about.html">Terms & Policy</a></label
            >
          </div>
        </div>
      </div>
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto d-lg-none d-block">
                            <div class="header-logo">
                                @if(getSiteSetting('logo_image') !== null)
                                  <a href="{{ url('/') }}">
                                      <img class="light-img" src="{{ getSiteSetting('logo_image') }}"  alt={{ getSiteSetting('site_title') }} alt="logo" style="height: 40px;"/>
                                  </a>
                                @else
                                    <h5 class="company-name">
                                        {{ getSiteSetting('site_title') }}
