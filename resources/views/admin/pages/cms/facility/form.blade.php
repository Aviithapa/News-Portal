                    ...
                    <div class="row mt-5">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                       @if(isset($model))
                                             <form method="POST" action="{{ route('facility.update', ["facility" => $model->id]) }}" enctype="multipart/form-data">
                                                 @method('PUT')
                                        @else
                                        ...
                                        <div class="row"> 
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="validationCustom01" placeholder="Type" name="type" value="Facility Management" disabled>
                                                     @if($errors->any())
                                                         {{ $errors->first('email') }}
                                                      @endif
                                                </div>
                                              ...
                                              <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="validationCustom01" placeholder="Icon class name" name="icon" value="{{ isset($model) ? $model->icon : old('icon') }}">
                                                     @if($errors->any())
                                                         {{ $errors->first('icon') }}
                                                      @endif
                                                </div>
