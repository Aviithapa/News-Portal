  ...
  <!-- start page title -->
                        ...
                        <!-- end page title -->
                         ...
                         <div class="card">
                                    ...
                                    <form action="{{  route("facility.index") }}"  method="GET" novalidate>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="p-3">
                                            <div class="card-widgets">
                                                <a href="{{ route('facility.create') }}" class="btn btn-primary" style="color: white;">Create New Facility</a>
                                            </div>
                                            <h5 class="header-title mb-0">Facility List</h5>
                                        </div>
                                        ...
                                        <div id="yearly-sales-collapse" class="collapse show">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-nowrap table-hover mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $data->slug }}</td>
                                                            <td>{{ $data->excerpt }}</td>
                                                            <td><a href="{{ route('facility.edit', ['facility' => $data->id]) }}"><span class="badge bg-info-subtle text-info">Edit</span></a>
                                                               <a  data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat"  data-attr="{{ route('facility.destroy', ['facility' => $data->id]) }}" style="cursor: pointer;"><span class="badge bg-danger-subtle text-danger">Delete</span></a>                                                            </td>
                                                ...
                                                {{  $facilities->appends(request()->query())->links('admin.layout.pagination') }}
                                                </div>
                                            </div>        
                                        </div>
                                    </div>                           
